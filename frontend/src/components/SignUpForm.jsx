    ...
    >
      <div class="lg:w-1/2 xl:w-5/12 sm:p-12">
        ...
        <div class="mt-12 flex flex-col items-center">
          ...
          <h1 class="text-2xl xl:text-3xl font-bold text-[#1C2434]">
            Sign up for Ascenda Loyalty
          </h1>
          <div class="w-full flex-1 mt-8">
            <div class="flex flex-col items-center">
              ...
              <button
                class="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-white text-[#1C2434] flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5"
              >
      ...
      <div class="flex-1 bg-white text-center lg:flex">
...
<div id="default-carousel" class="relative w-full" data-carousel="slide">
    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="/rewards.png" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
        </div>
