...
export default function TopBar() {
  ...
  return (
    ...
    <div className='fixed top-0  w-full h-[6%] bg-blue-gray-800 z-10'>
        <div className="absolute flex right-[5%] mt-3">
          <img className="mx-2" src="/profile.png" alt="Profile" />
          <div>
            <h1 className="text-xs font-bold text-white ">{userName}</h1>
            <h1 className="block text-xs text-white opacity-80 ">{role}</h1>
          </div>
          <br></br>
